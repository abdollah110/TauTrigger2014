...
process.source = cms.Source("PoolSource",
                            ...
                            '/tmp/abdollah/patTuple_10_1_GbK.root',
                            '/tmp/abdollah/patTuple_11_1_agD.root',
                            '/tmp/abdollah/patTuple_12_1_ooX.root',
                            '/tmp/abdollah/patTuple_13_1_3Fd.root',
                            '/tmp/abdollah/patTuple_14_1_pKM.root',
                            '/tmp/abdollah/patTuple_15_1_EyL.root',
                            '/tmp/abdollah/patTuple_17_1_cTP.root',
                            '/tmp/abdollah/patTuple_19_1_vJU.root',
                            '/tmp/abdollah/patTuple_1_1_FSH.root',
                            '/tmp/abdollah/patTuple_20_1_1Ts.root',
                            '/tmp/abdollah/patTuple_21_1_fUF.root',
                            '/tmp/abdollah/patTuple_22_1_s3l.root',
                            '/tmp/abdollah/patTuple_23_1_pfR.root',
                            '/tmp/abdollah/patTuple_24_1_rsH.root',
                            '/tmp/abdollah/patTuple_25_1_0qn.root',
                            '/tmp/abdollah/patTuple_26_1_B5L.root',
                            '/tmp/abdollah/patTuple_27_1_hIV.root',
                            '/tmp/abdollah/patTuple_28_1_PqW.root',
                            '/tmp/abdollah/patTuple_2_1_sul.root',
                            '/tmp/abdollah/patTuple_3_1_8dl.root',
                            '/tmp/abdollah/patTuple_4_1_b7M.root',
                            '/tmp/abdollah/patTuple_5_1_0ZU.root',
                            '/tmp/abdollah/patTuple_6_1_uIE.root',
                            '/tmp/abdollah/patTuple_7_1_RMK.root',
                            '/tmp/abdollah/patTuple_8_1_84N.root',
                            '/tmp/abdollah/patTuple_9_1_Grb.root',
