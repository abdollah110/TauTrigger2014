...
FileRootRate = TFile(candidate + "Tau_L1" + candidate + "_rate2.root", "OPEN")
...
UCTCandidateCum4x4 = doCommulative(UCTCandidate4x4, UCTCandidate4x4, 22, 6, "L1 Rate")
UCTCandidateIsoCum4x4 = doCommulative(UCTCandidateIso4x4, UCTCandidateIso4x4, 27, 7, "L1 Rate")
