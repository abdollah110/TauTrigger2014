...
legend_.Draw()
AddCostumText()
canvas.SaveAs("MuTauEfficiencyUCTTau2x1DifferentL1Pt.pdf")
...
legend_.Draw()
AddCostumText()
canvas.SaveAs("MuTauEfficiencyUCTTau4x4DifferentL1Pt.pdf")
...
for iipt in ptL1:
    ...
    legend_.Draw()
    AddCostumText()
    canvas.SaveAs("MuTauEfficiencyCumulative2D"+str(iipt)+".pdf")
...
legend_.Draw()
AddCostumText()
canvas.SaveAs("MuTauRateCumulative.pdf")
...
#    legend_.Draw()
#    AddCostumText()
#    canvas.SaveAs("MuTauROC"+str(iipt)+".pdf")
