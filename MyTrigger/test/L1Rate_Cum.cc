...
void L1Rate_Cum() {
    ...
    for (int ii = 0; ii < 100; ii++) {
        ...
        outHist_L1JetParticle->SetBinContent(ii + 1, (L1JetParticle->Integral(ii, 100)*1.0) / L1JetParticle->GetEntries());
        outHist_UCTCandidate->SetBinContent(ii + 1, (UCTCandidate->Integral(ii, 100)*1.0) / UCTCandidate->GetEntries());
        outHist_UCTCandidateIso->SetBinContent(ii + 1, (UCTCandidateIso->Integral(ii, 100)*1.0) / UCTCandidateIso->GetEntries());
    }
    ...
    outHist_L1JetParticle->GetYaxis()->SetTitle("Rate Reduction on L1");
    ...
    std::string outNaming = "Rate_1.pdf";
