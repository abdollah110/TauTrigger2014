...
HistoRate.GetXaxis().SetBinLabel(3, "TauIsolation")
HistoRate.GetXaxis().SetBinLabel(4, "NewTauIsolation")
HistoRate.GetXaxis().SetBinLabel(5, "MuVeto")
HistoRate.GetXaxis().SetBinLabel(6, "Match Offline")
