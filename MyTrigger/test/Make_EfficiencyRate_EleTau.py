...
#FileRootEff = TFile("eleTau_L1Ele_efficiency.root", "OPEN")
...
#legend_.Draw()
#AddCostumText()
#canvas.SaveAs("EleTauEfficiencyUCTTau2x1DifferentL1Pt.pdf")
#
#FileRootEff = TFile("eleTau_L1Ele_efficiency.root", "OPEN")
#DenumEff = FileRootEff.Get("demo/offLineTauEff")
...
#legend_.Draw()
#AddCostumText()
#canvas.SaveAs("EleTauEfficiencyUCTTau4x4DifferentL1Pt.pdf")
#
#
#
#FileRootEff = TFile("eleTau_L1Ele_efficiency.root", "OPEN")
...
#legend_.Draw()
#AddCostumText()
#canvas.SaveAs("EleTauEfficiencyDifferentL1Algo.pdf")
#
#
#
#FileRootEff = TFile("eleTau_L1Ele_efficiency.root", "OPEN")
...
#Num_IsolatedTauROC4x42D = FileRootEff.Get("demo/Eff2D_Num_IsolatedTauUnpacked4x4")
#ptL1=[20,40]
#for iipt in ptL1:
#    l1extraROC = doCommulative2D(iipt,Num_l1extraROC, DenumROC, 21, 2, "Efficiency")
#    RelaxedTauROC = doCommulative2D(iipt,Num_RelaxedTauROC2D, DenumROC, 22, 3, "Efficiency")
#    IsolatedTauROC = doCommulative2D(iipt,Num_IsolatedTauROC2D, DenumROC, 23, 4, "Efficiency")
#    RelaxedTau4x4ROC = doCommulative2D(iipt,Num_RelaxedTauROC4x42D, DenumROC, 24, 6, "Efficiency")
#    IsolatedTau4x4ROC = doCommulative2D(iipt,Num_IsolatedTauROC4x42D, DenumROC, 25, 7, "Efficiency")
#    l1extraROC.Draw("P")
...
#    legend_.Draw()
#    AddCostumText()
#    canvas.SaveAs("EleTauEfficiencyCumulative2D"+str(iipt)+".pdf")



FileRootRate = TFile("eleTau_L1Ele_rate.root", "OPEN")
...
legend_.Draw()
AddCostumText()
canvas.SaveAs("EleTauRateCumulative.pdf")


#MMM= doProject2DX(20,Num_RelaxedTauROC2D)
#canvas.SetLogy(0)
#MMM.Draw()
#print MMM.Integral(0,100)
#canvas.SaveAs("MMM.pdf")

#ptL1=[20,40]
#for iipt in ptL1:
#    L1JetParticleROC = doROCCurve(iipt,doProject2DX(iipt,Num_l1extraROC), DenumROC, L1JetParticle, L1JetParticle, 21, 2)
#    UCTCandidateROC = doROCCurve(iipt,doProject2DX(iipt,Num_RelaxedTauROC2D), DenumROC, UCTCandidate, UCTCandidate, 22, 3)
#    UCTCandidateIsoROC = doROCCurve(iipt,doProject2DX(iipt,Num_IsolatedTauROC2D), DenumROC, UCTCandidateIso, UCTCandidateIso, 23, 4)
#    UCTCandidateROC4x4 = doROCCurve(iipt,doProject2DX(iipt,Num_RelaxedTauROC4x42D), DenumROC, UCTCandidate4x4, UCTCandidate4x4, 24, 6)
#    UCTCandidateIsoROC4x4 = doROCCurve(iipt,doProject2DX(iipt,Num_IsolatedTauROC4x42D), DenumROC, UCTCandidateIso4x4, UCTCandidateIso4x4, 25, 7)
...
#    legend_.Draw()
#    AddCostumText()
#    canvas.SaveAs("EleTauROC"+str(iipt)+".pdf")
...
#UCTCandidateROC4x4 = doROCCurve(Num_RelaxedTauROC4x4, DenumROC, UCTCandidate4x4, UCTCandidate4x4, 24, 6)
#UCTCandidateIsoROC4x4 = doROCCurve(Num_IsolatedTauROC4x4, DenumROC, UCTCandidateIso4x4, UCTCandidateIso4x4, 25, 7)
#L1JetParticleROC.Draw("P")
#UCTCandidateROC.Draw("Psame")
#UCTCandidateIsoROC.Draw("Psame")
#UCTCandidateROC4x4.Draw("Psame")
